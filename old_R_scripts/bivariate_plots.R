...
data <- read.csv("data_every_hour_obs.csv")                           
...
ppEC<-polarPlot(mergeddata, pollutant = "C Elemental", statistic = "mean",  min.bin = 2, 
          upper =upper_windspeed, key.footer="EC",mis.col = "transparent",
          cols=colorset)
ppOC<-polarPlot(mergeddata, pollutant = "C Orgánico", statistic = "mean",  min.bin = 2, 
                upper =upper_windspeed, key.footer="OC",mis.col = "transparent",
                cols=colorset)
png(paste0(pathgraphs,"/polarplotECOC_",colorset,".png"), width = 717 * 5, height = 339* 5, res = 300)
