...
def mass_reconstruction_all(conc_matrix, unc_matrix, events, equation='Simon_2011', event_labels=['SP', 'S', 'SN','SL','SC'], 
                            event_column="Event_M", betas_event=[0,2.6,1,1,1], betas_noevent=[0,2,1,1,1], betas_all =[0,1.5,1,1,1],
